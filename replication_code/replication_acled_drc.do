...
save drc_temp.dta, replace 


merge 1:1 event_id_cnty using drc_complete.dta
drop _merge 
drop actor_*
save drc_matched.dta, replace 
...
export delim A_minus_drc.csv, replace 
...
save A_plus, replace
export delim A_plus_drc.csv, replace 
...
merge 1:1 idA using tf_drc.dta
keep if _merge==3
drop _merge
gen degree_minus = enemy 
gen degree_plus = allied
export delim data_drc.csv, replace 
...
/*----------------------------------------------------*/
   /* [>   Merge back to Data from paper.  title   <] */ 
/*----------------------------------------------------*/
