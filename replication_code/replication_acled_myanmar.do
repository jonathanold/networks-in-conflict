...
forv i=1/2 {
	replace actor`i'="Myanmar2011" if substr(actor`i',1,32)=="Military Forces of Myanmar (1988"
	replace actor`i'="Myanmar2016" if substr(actor`i',1,32)=="Military Forces of Myanmar (2011"
	replace actor`i'="Myanmar2021" if substr(actor`i',1,32)=="Military Forces of Myanmar (2016"
	replace actor`i'="Mayanmar2023" if substr(actor`i',1,32)=="Military Forces of Myanmar (2021"
	
	replace actor`i'="Police2011" if substr(actor`i',1,30)=="Police Forces of Myanmar (1988"
	replace actor`i'="Police2016" if substr(actor`i',1,30)=="Police Forces of Myanmar (2011"
	replace actor`i'="Police2021" if substr(actor`i',1,30)=="Police Forces of Myanmar (2016"
	replace actor`i'="Police2023" if substr(actor`i',1,30)=="Police Forces of Myanmar (2021"
...
save myanmar_complete.dta, replace 
...
save myanmar_temp.dta, replace 


merge 1:1 event_id_cnty using myanmar_complete.dta
drop _merge 
drop actor_*
save myanmar_matched.dta, replace 
...
export delim A_minus_myanmar.csv, replace 
...
save A_plus, replace
export delim A_plus_myanmar.csv, replace 
...
merge 1:1 idA using tf_myanmar.dta
keep if _merge==3
drop _merge
gen degree_minus = enemy 
gen degree_plus = allied
export delim data_myanmar.csv, replace 
