...
import delim using "../data_acled/1900-01-01-2023-05-11-iraq.csv", clear
...
save iraq_complete.dta, replace 
...
save iraq_temp.dta, replace 


merge 1:1 event_id_cnty using iraq_complete.dta
drop _merge 
drop actor_*
save iraq_matched.dta, replace 
...
save tf_iraq_year.dta, replace 




use iraq_temp.dta, replace 
...
/*----------------------------------------------------*/
use iraq_dyad.dta, replace 

collapse (sum)  enemy allied neutral, by(idA )

merge 1:m idA using tf_iraq_year.dta
keep if _merge==3
drop _merge
...
gsort idA year
export delim data_iraq_year.csv, replace 
...
export delim A_minus_iraq.csv, replace 
...
save A_plus, replace
export delim A_plus_iraq.csv, replace 
...
merge 1:1 idA using tf_iraq.dta
keep if _merge==3
drop _merge
gen degree_minus = enemy 
gen degree_plus = allied
export delim data_iraq.csv, replace 
