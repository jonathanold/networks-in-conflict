...
import delim using "../data_acled/1900-01-01-2023-05-11-afghanistan.csv", clear
...
save afghanistan_complete.dta, replace 
...
save afghanistan_temp.dta, replace 


merge 1:1 event_id_cnty using afghanistan_complete.dta
drop _merge 
drop actor_*
save afghanistan_matched.dta, replace 
...
/*----------------------------------------------------*/
use afghanistan_matched.dta, replace 
...
keep idA tf* 
save tf_afghanistan.dta, replace 
...
save tf_afghanistan_year.dta, replace 





use afghanistan_temp.dta, replace 
...
save afghanistan_dyad.dta, replace 
...
/*----------------------------------------------------*/
use afghanistan_dyad.dta, replace 

collapse (sum)  enemy allied neutral, by(idA )

merge 1:m idA using tf_afghanistan_year.dta
keep if _merge==3
drop _merge
...
gsort idA year
export delim data_afghanistan_year.csv, replace 
...
export delim A_minus_afghanistan.csv, replace 
...
save A_plus, replace
export delim A_plus_afghanistan.csv, replace 
...
merge 1:1 idA using tf_afghanistan.dta
keep if _merge==3
drop _merge
gen degree_minus = enemy 
gen degree_plus = allied
export delim data_afghanistan.csv, replace 
