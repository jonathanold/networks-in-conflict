...
import delim using "../data_acled/1900-01-01-2023-05-11-Yemen.csv", clear
...
save yemen_complete.dta, replace 
...
save yemen_temp.dta, replace 


merge 1:1 event_id_cnty using yemen_complete.dta
drop _merge 
drop actor_*
save yemen_matched.dta, replace 
...
save tf_yemen_year.dta, replace 





use yemen_temp.dta, replace 
...
/*----------------------------------------------------*/
use yemen_dyad.dta, replace 

collapse (sum)  enemy allied neutral, by(idA )

merge 1:m idA using tf_yemen_year.dta
keep if _merge==3
drop _merge
...
gsort idA year
export delim data_yemen_year.csv, replace 
...
export delim A_minus_yemen.csv, replace 
...
save A_plus, replace
export delim A_plus_yemen.csv, replace 
...
merge 1:1 idA using tf_yemen.dta
keep if _merge==3
drop _merge
gen degree_minus = enemy 
gen degree_plus = allied
export delim data_yemen.csv, replace 
